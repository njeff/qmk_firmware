/**
 * Adapted from the Sparkfun Library by njeff
 *
...
uint8_t wireWriteByte(uint8_t val)
{
    return i2c_transmit(APDS9960_I2C_ADDR, &val, 1, TIMEOUT) == I2C_STATUS_SUCCESS;
}
...
uint8_t wireWriteDataByte(uint8_t reg, uint8_t val)
{
    return i2c_writeReg(APDS9960_I2C_ADDR, reg, &val, 1, TIMEOUT) == I2C_STATUS_SUCCESS;
}
...
uint8_t wireWriteDataBlock(  uint8_t reg, 
                          ...
                          unsigned int len)
{
    return i2c_writeReg(APDS9960_I2C_ADDR, reg, val, len, TIMEOUT) == I2C_STATUS_SUCCESS;
}
...
uint8_t wireReadDataByte(uint8_t reg, uint8_t *val)
{
    ...
    return i2c_readReg(APDS9960_I2C_ADDR, reg, val, 1, TIMEOUT) == I2C_STATUS_SUCCESS;
}
